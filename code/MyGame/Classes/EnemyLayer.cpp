...
bool EnemyLayer::init() {
    ...
    auto scoreItem = Label::createWithTTF("0", "fonts/Marker Felt.ttf", 15);
    scoreItem->setAnchorPoint(Vec2(0,1));
    scoreItem->setPosition(Point(origin.x,visibleSize.height));
    scoreItem->setTag(20);
...
void EnemyLayer::updateScore(int score) {
    auto sItem = (Label*)this->getChildByTag(20);
    sItem->setString(StringUtils::toString(score));
}
